...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 text-white py-4 md:py-12 px-4 md:px-8 lg:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 mb-6">
          ...
          {/* Shortcuts */}
          <div className="flex mb-4 md:col-span-2 md:justify-center gap-14">
            {/* Quick Links */}
            <div>
          ...
          <div className="lg:-ml-7">
            ...
            <div>
              <div className="flex items-center gap-1">
                ...
                <Link href="mailto:info@soujtaexim.com" className="text-sm text-gray-400 hover:text-white transition">
                  info@soujtaexim.com
                </Link>
              </div>
              <div className="flex items-center gap-1">
                <p className="text-sm text-gray-400">Phone:</p>
                <Link href="tel:+919674264091" className="text-sm text-gray-400 hover:text-white transition">
                  +91 96742 64091
                </Link>
              </div>
            ...
            <h4 className="font-semibold mb-2 text-lg">Factory Address</h4>
            <p className="text-sm text-gray-400">
